...
namespace APIPRUEBAS.Controllers
{
	...
	{
		public readonly BbContext _bbcontext;
		...
		public IActionResult Lista()
		{
			...
			try
			{
				lista = _bbcontext.Productos.Include(c => c.oCategoria).ToList();
		...
		{
			Producto oProducto = _bbcontext.Productos.Find(idProducto);
			...
			try
			{
				...
				oProducto = _bbcontext.Productos.Include(c => c.oCategoria).Where(p => p.IdProducto == idProducto).FirstOrDefault();
		...
		public IActionResult Guardar([FromBody] Producto objeto)
		{
			...
			try
			{
				_bbcontext.Productos.Add(objeto);
		...
		{
			Producto oProducto = _bbcontext.Productos.Find(objeto.IdProducto);
			...
			try
			{
				...
				_bbcontext.Productos.Update(oProducto);
				_bbcontext.SaveChanges();
		...
		public IActionResult Eliminar(int idProducto)
		{
			...
			try
			{
				...
				_bbcontext.Productos.Remove(oProducto);
				_bbcontext.SaveChanges();
